...
export function RolesEditModal({
  ...
  const availabilityOptions: Array<{
    ...
    {
      id: "AVAILABLE_NOW",
      labelTr: "Hemen Başlayabilir (Acil / Hazır)",
      labelEn: "Available Now (Immediate)",
    ...
    {
      id: "FULL_TIME",
      labelTr: "Tam Zamanlı Açık (35-40 saat/hafta)",
      labelEn: "Open to Full-Time (35-40 hrs/wk)",
      subtextTr: "Uzun soluklu tam zamanlı sözleşmelere ve pozisyonlara açık.",
      subtextEn: "Open to long-term full-time contracts or positions.",
      colorClasses: "border-blue-500/30 bg-blue-500/10 text-blue-400",
      dotColor: "bg-blue-400",
    },
    {
      id: "PARTIALLY_AVAILABLE",
      labelTr: "Yarı Zamanlı (10-20 saat/hafta)",
      labelEn: "Part-Time (10-20 hrs/wk)",
      subtextTr: "Haftada sınırlı saat ayırabilir, esnek projelere açık.",
    ...
    {
      id: "PROJECT_BASED",
      labelTr: "Proje Bazlı / Serbest (Sprint & Teslimat)",
      labelEn: "Project-Based / Freelance (Sprints)",
      subtextTr: "Belirli süreli sprintler ve anahtar teslim projeler için müsait.",
      subtextEn: "Available for scoped sprints and milestone-based deliverables.",
      colorClasses: "border-purple-500/30 bg-purple-500/10 text-purple-400",
      dotColor: "bg-purple-400",
    },
    {
      id: "ADVISORY",
      labelTr: "Danışmanlık & Mentorluk (Stratejik Rehberlik)",
      labelEn: "Advisory & Mentorship",
      subtextTr: "Mimari inceleme, kod denetimi ve teknik danışmanlık.",
      subtextEn: "Architecture review, code audit, and strategic advisory.",
      colorClasses: "border-indigo-500/30 bg-indigo-500/10 text-indigo-400",
      dotColor: "bg-indigo-400",
    },
    {
      id: "VOLUNTEER",
      labelTr: "Gönüllü & Sosyal Fayda (Pro Bono)",
      labelEn: "Volunteer & Pro Bono",
      subtextTr: "Açık kaynak, sivil toplum ve sosyal etki projelerine destek.",
      subtextEn: "Open source, non-profit, and social impact contributions.",
      colorClasses: "border-teal-500/30 bg-teal-500/10 text-teal-400",
      dotColor: "bg-teal-400",
    },
    {
      id: "INTERNSHIP",
      labelTr: "Staj & Çıraklık (Junior İş Birlikleri)",
      labelEn: "Internship & Apprenticeship",
      subtextTr: "Junior geliştirici, mentorluk ve stajyerlik fırsatlarına açık.",
      subtextEn: "Open to junior tracks, learning partnerships, and internships.",
      colorClasses: "border-sky-500/30 bg-sky-500/10 text-sky-400",
      dotColor: "bg-sky-400",
    },
    {
      id: "BUSY",
