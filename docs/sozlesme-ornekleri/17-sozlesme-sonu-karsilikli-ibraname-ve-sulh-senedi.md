...
### 1. TARAFLAR
1. **İŞVEREN (MÜŞTERİ):** **Acme Teknoloji ve Girişim A.Ş.** (VKN/TCKN: 1234567890) — hukuk@acmeteknoloji.com.tr  
2. **YÜKLENİCİ (GELİŞTİRİCİ):** **Can Demir (Kıdemli Yazılım Mimarı)** (TCKN/VKN: 10000000146) — can.demir@devmail.com  
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | **Tasarım ve Mimari Altyapı Onayı** | 45.000 TL | `EFT-TR-20260902-881923` | Teyit Edildi | `DOĞRULANDI` |
| 2 | **Fonksiyonel Demo ve Kullanıcı Kabul Testi** | 60.000 TL | `EFT-TR-20260925-992014` | Teyit Edildi | `DOĞRULANDI` |
| 3 | **Kaynak Kod Teslimi ve FSEK m. 52 Telif Devri** | 45.000 TL | `EFT-TR-20261021-110293` | Teyit Edildi | `DOĞRULANDI` |
| 4 | **Zeyilname-1 Ek Kapsam Hakedişi** | 25.000 TL | `EFT-TR-20261021-110294` | Teyit Edildi | `DOĞRULANDI` |

**Toplam İtfa Edilen Bedel:** **175.000 TL**
...
1. 6098 sayılı TBK m. 477/2 uyarınca yüklenicinin kasten gizlediği hileli ve ağır kusurlu ayıplara karşı haklar saklıdır.
2. 5846 sayılı FSEK m. 52 uyarınca tescil edilen Fikri Mülkiyet Devir Senetlerinin (IP Deeds) geçerliliği tam olarak devam eder.
3. Karşılıklı Gizlilik Protokolü (NDA) kapsamındaki ticari sır saklama yükümlülükleri yürürlükte kalır.
