...
2. **ORTAK YÜKLENİCİLER KONSORSİYUMU (ÇEVİK EKİP - TBK m. 620):**
   - **Kolektif / Konsorsiyum Adı:** Operis Cloud & Full-Stack Mühendislik Kolektifi
   - **LİDER YÜKLENİCİ (Tek Yetkili Koordinatör & Muhatap):** Can Demir (Kıdemli Yazılım Mimarı) (can.demir@devmail.com)
   - **KONSORSİYUM ÜYELERİ VE HAKEDİŞ DAĞILIMI:**

| Sıra | Adı Soyadı / Uzman | Rol / Uzmanlık Alanı | Hakediş Oranı (%) | Sorumluluk / İş Kapsamı |
|---|---|---|---|---|
| 1 | **Can Demir** *(Lider Yüklenici)* | Lider Mimar & Sistem Mühendisi | %40 | Sistem mimarisi, DevOps, veritabanı optimizasyonu ve teknik koordinasyon |
| 2 | **Selin Yılmaz**  | Kıdemli Frontend Mimarı | %35 | Next.js UI bileşenleri, Tailwind entegrasyonu, harita ve telemetri panelleri |
| 3 | **Burak Kaya**  | Kıdemli QA ve Güvenlik Uzmanı | %25 | Uçtan uca Playwright/Vitest testleri, OWASP güvenlik denetimleri ve CI/CD |
1.3. **Konsorsiyum Hukuki Statüsü ve Lider Yüklenici Yetkisi (TBK m. 620 & TBK m. 162):** Ortak Yükleniciler, 6098 sayılı Türk Borçlar Kanunu Madde 620 vd. uyarınca bir adi ortaklık / konsorsiyum teşkil etmiştir. İş Sahibi nezdinde teknik koordinasyonu yürütmek, aşama teslimatlarını sunmak ve bildirimleri kabule yetkili tek muhatap Can Demir (Kıdemli Yazılım Mimarı) ("Lider Yüklenici") olarak belirlenmiştir. Ortak Yüklenicilerin her biri kendi üstlendiği uzmanlık alanındaki işlerin ayıpsız ifasından ve teslimatın bütünlüğünden işverene karşı müştereken sorumludur.

---

### MADDE 2: SÖZLEŞMENİN KONUSU VE TEKNİK KAPSAMI (TBK m. 470)
İşbu Sözleşmenin konusu; Yüklenici tarafından İş Sahibi için aşağıda teknik özellikleri ve başlığı belirtilen **"Yeni Nesil B2B Lojistik ve Tedarik Zinciri Yönetim Portalı"** projesine ilişkin yazılım geliştirme, arayüz tasarımı, mimari yapılandırma ve ilgili teknoloji hizmetlerinin TBK m. 470 anlamında bağımsız bir "eser" olarak meydana getirilmesi ve teslimidir.
- **Kategori:** Full-Stack Web & Bulut Mimarisi
- **Mutabık Kalınan Teknik Kapsam:** Mikroservis mimarisinde, filo takip entegrasyonlu ve yüksek erişilebilirliğe sahip lojistik operasyon portalının çevik ekip konsorsiyumu tarafından geliştirilmesi.

---

### MADDE 3: PROJE BEDELİ, FATURALANDIRMA VE KİLOMETRE TAŞLARI
3.1. **Kararlaştırılan Proje Bedeli:** 350.000 TL  
...
| :--- | :--- | :--- | :--- |
| **1. Kararlaştırılan Brüt Hizmet Bedeli** | Sözleşme Esası | **350.000,00 ₺** | Taraflarca mutabık kalınan brüt hakediş bedeli. |
| **2. GVK m. 94/2-b Stopaj Tevkifatı** | %20 | **-70.000,00 ₺** | İş Sahibi tarafından doğrudan muhtasar beyanname ile vergi dairesine ödenir. |
| **3. Net Serbest Meslek Kazancı** | Net Hakediş | **280.000,00 ₺** | Yüklenicinin brüt bedelden stopaj düşüldükten sonraki net kazancı. |
| **4. Katma Değer Vergisi (KDVK)** | %20 | **+70.000,00 ₺** | Yükleniciye emaneten ödenir; 1 No.lu KDV beyannamesi ile devlete iletilir. |
| **5. Banka Havalesi ile Yükleniciye Ödenecek** | Net + KDV | **350.000,00 ₺** | İş Sahibi tarafından Yüklenici banka hesabına havale/EFT yapılacak tutar. |
| **6. İş Sahibinin Toplam Nakit Maliyeti** | Brüt + KDV | **420.000,00 ₺** | Banka havalesi + Muhtasar vergi dairesi stopajı toplam nakit çıkışı. |
...
4.1. **Öngörülen Teslimat Süresi:** 60 İş Günü  
...
**Tarih:** 5 Eylül 2026 | **İmza / Kaşe:** ___________________  
**Tarih:** 5 Eylül 2026 |
