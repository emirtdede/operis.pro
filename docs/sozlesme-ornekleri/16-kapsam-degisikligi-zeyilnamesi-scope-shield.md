...
İşbu Sözleşme Zeyilnamesi ("Zeyilname"), aşağıda bilgileri yer alan taraflar arasında akdedilmiş bulunan **"Kurumsal B2B Finansal Raporlama ve Analitik Platformu"** konulu ve **`OPR-CONTR-ENG2026B`** referans kodlu Bağımsız Yazılım ve Teknoloji Hizmet Sözleşmesi'nin ("Ana Sözleşme") ayrılmaz bir parçası olarak düzenlenmiştir:

1. **İŞ SAHİBİ (MÜŞTERİ):** Acme Teknoloji ve Girişim A.Ş. (hukuk@acmeteknoloji.com.tr / +90 (212) 555 8899)
2. **YÜKLENİCİ (GELİŞTİRİCİ):** Can Demir (Kıdemli Yazılım Mimarı) (can.demir@devmail.com / +90 (532) 555 1234)

---

### MADDE 2: DEĞİŞİKLİK GEREKÇESİ VE İLAVE İŞLERİN KAPSAMI
2.1. **Değişiklik Gerekçesi:** İş Sahibi (Müşteri) Tarafından Talep Edilen İlave Özellik / Kapsam Genişlemesi  
2.2. **Değişiklik Talebi Başlığı:** **TCMB Entegrasyonu ve Çoklu Para Birimi Modülü**  
...
3.1. **İlave Hizmet Bedeli:** **+25.000,00 TRY**  
...
4.1. **Ek Teslimat Süresi:** **+10 takvim günü**  
