...
### 1. TARAFLAR
1. **İŞVEREN (MÜŞTERİ):** **Nova Perakende ve Mağazacılık A.Ş.** — hukuk@novaperakende.com  
2. **YÜKLENİCİ (GELİŞTİRİCİ):** **Can Demir (Kıdemli Yazılım Mimarı)** — can.demir@devmail.com  

---

### 2. TASFİYE VE MALİ HESAP TABLOSU
- **İtfa Edilen / Ödenen Hakedişler:** **40.000 TL** (1 Aşama)
- **Tasfiye Edilen / İptal Edilen Bakiye:** **60.000 TL** (1 Aşama)
...
- [x] Sunucu, API ve Bulut Yönetici Yetkileri İade Edildi: **EVET**
- [x] O Ana Kadar Yazılan Kaynak Kodlar Aktarıldı: **EVET**
- [x] Mevcut Teknik Dokümantasyon Teslim Edildi: **EVET**
